...
namespace ProxyStubs {
    ...
    public:
        ...
        void Register(const string& _nameSpace, Exchange::IDictionary::INotification* _sink) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IDictionary>::Invoke(message);
    ...
    public:
        ...
        void Modified(const string& _nameSpace, const string& _key, const string& _value) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IDictionary::INotification>::Invoke(message);
        }
    ...
    public:
        ...
        void Reset() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IDictionary::IIterator>::Invoke(message);
        }
        ...
        bool IsValid() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IDictionary::IIterator>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Boolean();
            }
