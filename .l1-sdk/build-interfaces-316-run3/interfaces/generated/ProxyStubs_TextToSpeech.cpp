...
namespace ProxyStubs {
    ...
    //  (2) virtual void RegisterWithCallsign(const string, Exchange::ITextToSpeech::INotification*) = 0
    //  (3) virtual uint32_t Enable(const bool) = 0
    //  (4) virtual uint32_t Enable(bool&) const = 0
    //  (5) virtual uint32_t SetConfiguration(const Exchange::ITextToSpeech::Configuration&, Exchange::ITextToSpeech::TTSErrorDetail&) = 0
    //  (6) virtual uint32_t SetFallbackText(const string, const string) = 0
    //  (7) virtual uint32_t SetAPIKey(const string) = 0
    //  (8) virtual uint32_t SetPrimaryVolDuck(const uint8_t) = 0
    //  (9) virtual uint32_t SetACL(const string, const string) = 0
    //  (10) virtual uint32_t GetConfiguration(Exchange::ITextToSpeech::Configuration&) const = 0
    //  (11) virtual uint32_t ListVoices(const string, RPC::IStringIterator*&) const = 0
    //  (12) virtual uint32_t Speak(const string, const string, uint32_t&, Exchange::ITextToSpeech::TTSErrorDetail&) = 0
    //  (13) virtual uint32_t Cancel(const uint32_t) = 0
    //  (14) virtual uint32_t Pause(const uint32_t, Exchange::ITextToSpeech::TTSErrorDetail&) = 0
    //  (15) virtual uint32_t Resume(const uint32_t, Exchange::ITextToSpeech::TTSErrorDetail&) = 0
    //  (16) virtual uint32_t GetSpeechState(const uint32_t, Exchange::ITextToSpeech::SpeechState&) = 0
    //
    ...
    ProxyStub::MethodHandler ExchangeTextToSpeechStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            implementation->RegisterWithCallsign(_callsign, _sink);
    ...
    public:
        ...
        void Register(Exchange::ITextToSpeech::INotification* _sink) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ITextToSpeech>::Invoke(message);
        ...
        void RegisterWithCallsign(const string _callsign, Exchange::ITextToSpeech::INotification* _sink) override
        {
    ...
    public:
        ...
        void Enabled(const bool _state) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::ITextToSpeech::INotification>::Invoke(message);
        }
