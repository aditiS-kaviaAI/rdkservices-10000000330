...
namespace ProxyStubs {
    ...
    public:
        ...
        Exchange::IDIALServer::IApplication* Application(const string& _name) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IDIALServer>::Invoke(message);
    ...
    public:
        ...
        uint32_t AdditionalDataURL(string& _url) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IDIALServer::IApplication>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
