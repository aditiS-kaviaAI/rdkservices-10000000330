...
namespace ProxyStubs {
    ...
    public:
        ...
        uint32_t Install(const std::string& _type, const std::string& _id, const std::string& _version, const std::string& _url, const std::string& _appName, const std::string& _category, std::string& _handle) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA>::Invoke(message);
    ...
    public:
        ...
        uint32_t Path(string& _path) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IStorage>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
                _path = reader.Text();
    ...
    public:
        ...
        uint32_t Apps(Exchange::ILISA::IStorage*& _storage) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IStoragePayload>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
    ...
    public:
        ...
        uint32_t Key(string& _key) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IKeyValue>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
                _key = reader.Text();
    ...
    public:
        ...
        uint32_t Reset() override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IKeyValueIterator>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
            }
    ...
    public:
        ...
        uint32_t AppName(std::string& _appName) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IMetadataPayload>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
    ...
    public:
        ...
        void operationStatus(const string& _handle, const string& _operation, const string& _type, const string& _id, const string& _version, const string& _status, const string& _details) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::ILISA::INotification>::Invoke(message);
        }
    ...
    public:
        ...
        uint32_t Version(string& _version) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IAppVersion>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
    ...
    public:
        ...
        uint32_t Reset() override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IAppVersion::IIterator>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
            }
    ...
    public:
        ...
        uint32_t Type(string& _type) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IApp>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
                _type = reader.Text();
    ...
    public:
        ...
        uint32_t Reset() override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IApp::IIterator>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
            }
    ...
    public:
        ...
        uint32_t Apps(Exchange::ILISA::IApp::IIterator*& _apps) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IAppsPayload>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
    ...
    public:
        ...
        uint32_t Handle(std::string& _handle) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::IHandleResult>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
                _handle = reader.Text();
    ...
    public:
        ...
        uint32_t Reason(std::string& _reason) const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ILISA::ILockInfo>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
                _reason = reader.Text();
