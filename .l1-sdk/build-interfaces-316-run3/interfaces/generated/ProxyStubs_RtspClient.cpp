...
namespace ProxyStubs {
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _service) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IRtspClient>::Invoke(message);
        ...
        void Set(const string& _name, const string& _value) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IRtspClient>::Invoke(message);
        }
