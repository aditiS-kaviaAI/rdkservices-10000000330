...
//   - /* instantiated */ template class RPC::IIteratorType<typename ELEMENT, const uint32_t> [with ELEMENT = KeyValue, INTERFACE_ID = ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR]
//   - /* instantiated */ template class RPC::IIteratorType<typename ELEMENT, const uint32_t> [with ELEMENT = PackageKey, INTERFACE_ID = ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR]
...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance272EC272 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance272EC272StubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
    ...
    }; // RPCIteratorTypeInstance272EC272StubMethods

    //
    // RPC::IIteratorTypeInstance9D78195B interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance9D78195BStubMethods[] = {
        // (0) virtual bool Next(Exchange::IPackageManager::KeyValue&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
    ...
    }; // RPCIteratorTypeInstance9D78195BStubMethods

    //
    // RPC::IIteratorTypeInstanceC8AEC1A0 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceC8AEC1A0StubMethods[] = {
        // (0) virtual bool Next(Exchange::IPackageManager::PackageKey&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
    ...
    }; // RPCIteratorTypeInstanceC8AEC1A0StubMethods
    ...
    //
    // RPC::IIteratorTypeInstance272EC272 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstance272EC272Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstance272EC272Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance272EC272Proxy

    //
    // RPC::IIteratorTypeInstance9D78195B interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPackageManager::KeyValue&) = 0
    //  (1) virtual bool Previous(Exchange::IPackageManager::KeyValue&) = 0
    ...
    class RPCIteratorTypeInstance9D78195BProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>> {
    public:
        RPCIteratorTypeInstance9D78195BProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
        ...
        bool Next(Exchange::IPackageManager::KeyValue& _info) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Boolean();
        ...
        void Reset(const uint32_t _position) override
        {
            ...
            ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>>::Invoke(message);
        }
    ...
    }; // class RPCIteratorTypeInstance9D78195BProxy

    //
    // RPC::IIteratorTypeInstanceC8AEC1A0 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPackageManager::PackageKey&) = 0
    //  (1) virtual bool Previous(Exchange::IPackageManager::PackageKey&) = 0
    ...
    class RPCIteratorTypeInstanceC8AEC1A0Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceC8AEC1A0Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
        ...
        bool Next(Exchange::IPackageManager::PackageKey& _info) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Boolean();
        ...
        void Reset(const uint32_t _position) override
        {
            ...
            ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>>::Invoke(message);
        }
    ...
    }; // class RPCIteratorTypeInstanceC8AEC1A0Proxy
    ...
    public:
        ...
        uint32_t Install(const string& _type, const string& _id, const string& _version, const string& _url, const string& _appName, const string& _category, string& _handle) override
        {
            ...
            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPackageManager>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        void OperationStatus(const string& _handle, const string& _operation, const string& _type, const string& _id, const string& _version, const string& _status, const string& _details) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IPackageManager::INotification>::Invoke(message);
        }
    ...
    public:
        ...
        uint32_t Offer(Exchange::IPackageManager* _packagemanager) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPackageManagerBroker>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
                Complete(reader);
    ...
    public:
        ...
        void OperationStatusUpdate(const string& _handle, const string& _operation, const string& _type, const string& _id, const string& _version, const string& _status, const string& _details) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IPackageManagerCallback>::Invoke(message);
        }
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance272EC272StubMethods> RPCIteratorTypeInstance272EC272Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>, RPCIteratorTypeInstance9D78195BStubMethods> RPCIteratorTypeInstance9D78195BStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>, RPCIteratorTypeInstanceC8AEC1A0StubMethods> RPCIteratorTypeInstanceC8AEC1A0Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance272EC272Proxy, RPCIteratorTypeInstance272EC272Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>, RPCIteratorTypeInstance9D78195BProxy, RPCIteratorTypeInstance9D78195BStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>, RPCIteratorTypeInstanceC8AEC1A0Proxy, RPCIteratorTypeInstanceC8AEC1A0Stub>();
