...
namespace ProxyStubs {
    ...
    public:
        ...
        string Name() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IVoiceProducer>::Invoke(message);
        ...
        void Configure(const string& _settings) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IVoiceProducer>::Invoke(message);
        }
    ...
    public:
        ...
        Exchange::IVoiceProducer::IProfile::codec Codec() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IVoiceProducer::IProfile>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        void Start(const Exchange::IVoiceProducer::IProfile* _profile) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IVoiceHandler>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                Complete(reader);
            }
        ...
        void Stop() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IVoiceHandler>::Invoke(message);
        }
