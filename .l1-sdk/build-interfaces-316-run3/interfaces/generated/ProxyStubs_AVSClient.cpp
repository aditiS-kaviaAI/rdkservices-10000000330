...
namespace ProxyStubs {
    ...
    public:
        ...
        void Register(Exchange::IAVSController::INotification* _sink) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IAVSController>::Invoke(message);
        ...
        uint32_t Mute(const bool _muted) override
        {
            ...
            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IAVSController>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        void DialogueStateChange(const Exchange::IAVSController::INotification::dialoguestate _state) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IAVSController::INotification>::Invoke(message);
        }
    ...
    public:
        ...
        bool Initialize(PluginHost::IShell* _service, const string& _configuration) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IAVSClient>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
