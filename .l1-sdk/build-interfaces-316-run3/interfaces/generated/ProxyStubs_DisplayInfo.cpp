...
//   - /* instantiated */ template class RPC::IIteratorType<typename ELEMENT, const uint32_t> [with ELEMENT = HDRType, INTERFACE_ID = ID_HDR_ITERATOR]
//   - /* instantiated */ template class RPC::IIteratorType<typename ELEMENT, const uint32_t> [with ELEMENT = ColorimetryType, INTERFACE_ID = ID_COLORIMETRY_ITERATOR]
...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance1B00AA25 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance1B00AA25StubMethods[] = {
        // (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
        //
    ...
    }; // RPCIteratorTypeInstance1B00AA25StubMethods

    //
    // RPC::IIteratorTypeInstance3EFE292A interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance3EFE292AStubMethods[] = {
        // (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
    ...
    }; // RPCIteratorTypeInstance3EFE292AStubMethods
    ...
    ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_6a30c99cImplementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_6a30c99c = nullptr;
            ProxyStub::UnknownProxy* parameter_6a30c99cProxy = nullptr;
            if (parameter_6a30c99cImplementation != 0) {
                parameter_6a30c99cProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_6a30c99cImplementation, false, _parameter_6a30c99c);
                ASSERT((_parameter_6a30c99c != nullptr) && (parameter_6a30c99cProxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_6a30c99c);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_6a30c99cProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_6a30c99cProxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_9f8b7c2dImplementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_9f8b7c2d = nullptr;
            ProxyStub::UnknownProxy* parameter_9f8b7c2dProxy = nullptr;
            if (parameter_9f8b7c2dImplementation != 0) {
                parameter_9f8b7c2dProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_9f8b7c2dImplementation, false, _parameter_9f8b7c2d);
                ASSERT((_parameter_9f8b7c2d != nullptr) && (parameter_9f8b7c2dProxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_9f8b7c2d);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_9f8b7c2dProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_9f8b7c2dProxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            uint32_t result = implementation->HeightInCentimeters(_heigth);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);
            writer.Number<uint8_t>(_heigth);
        },
    ...
    //
    // RPC::IIteratorTypeInstance1B00AA25 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
    //  (1) virtual bool Previous(Exchange::IHDRProperties::HDRType&) = 0
    ...
    class RPCIteratorTypeInstance1B00AA25Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>> {
    public:
        RPCIteratorTypeInstance1B00AA25Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
        ...
        bool Next(Exchange::IHDRProperties::HDRType& _info) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>>::Invoke(message);
        ...
        void Reset(const uint32_t _position) override
        {
            ...
            ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>>::Invoke(message);
        }
    ...
    }; // class RPCIteratorTypeInstance1B00AA25Proxy

    //
    // RPC::IIteratorTypeInstance3EFE292A interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
    //  (1) virtual bool Previous(Exchange::IDisplayProperties::ColorimetryType&) = 0
    ...
    class RPCIteratorTypeInstance3EFE292AProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>> {
    public:
        RPCIteratorTypeInstance3EFE292AProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
        ...
        bool Next(Exchange::IDisplayProperties::ColorimetryType& _info) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Boolean();
        ...
        void Reset(const uint32_t _position) override
        {
            ...
            ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>>::Invoke(message);
        }
    ...
    }; // class RPCIteratorTypeInstance3EFE292AProxy
    ...
    public:
        ...
        uint32_t TotalGpuRam(uint64_t& _total) const override
        {
            ...
            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IGraphicsProperties>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_6a30c99c) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_6a30c99c));

            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IConnectionProperties>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                hresult = reader.Number<uint32_t>();
                Complete(reader);
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_9f8b7c2d) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_9f8b7c2d));
        ...
        uint32_t EDID(uint16_t& _length, uint8_t* _data) const override
        {
            ...
            if (hresult == Core::ERROR_NONE) {
                ...
                hresult = reader.Number<uint32_t>();
                if ((hresult & 0x80000000) == 0) {
                    _length = reader.Buffer<uint16_t>(_length, _data);
                }
            } else {
                hresult |= 0x80000000;
            }
        ...
        uint32_t HeightInCentimeters(uint8_t& _heigth) const override
        {
    ...
    public:
        ...
        void Updated(const Exchange::IConnectionProperties::INotification::Source _event) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IConnectionProperties::INotification>::Invoke(message);
        }
    ...
    public:
        ...
        uint32_t TVCapabilities(Exchange::IHDRProperties::IHDRIterator*& _type) const override
        {
            ...
            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IHDRProperties>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                hresult = reader.Number<uint32_t>();
                if ((hresult & 0x80000000) == 0) {
    ...
    public:
        ...
        uint32_t ColorSpace(Exchange::IDisplayProperties::ColourSpaceType& _cs) const override
        {
            ...
            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IDisplayProperties>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                hresult = reader.Number<uint32_t>();
                if ((hresult & 0x80000000) == 0) {
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstance1B00AA25StubMethods> RPCIteratorTypeInstance1B00AA25Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance3EFE292AStubMethods> RPCIteratorTypeInstance3EFE292AStub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstance1B00AA25Proxy, RPCIteratorTypeInstance1B00AA25Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance3EFE292AProxy, RPCIteratorTypeInstance3EFE292AStub>();
