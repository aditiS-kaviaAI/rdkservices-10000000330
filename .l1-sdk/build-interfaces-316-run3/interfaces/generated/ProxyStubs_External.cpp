...
namespace ProxyStubs {
    ...
    //  (4) virtual uint32_t Module(const uint8_t) = 0
    //  (5) virtual uint32_t Type() const = 0
    //  (6) virtual int32_t Minimum() const = 0
    //  (7) virtual int32_t Maximum() const = 0
    //  (8) virtual uint32_t Get(int32_t&) const = 0
    //  (9) virtual uint32_t Set(const int32_t) = 0
    //  (10) virtual void Evaluate() = 0
    //  (11) virtual string Metadata() const = 0
    //
    ...
    ProxyStub::MethodHandler ExchangeExternalStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            uint32_t result = implementation->Module(_module);
    ...
    public:
        ...
        void Register(Exchange::IExternal::INotification* _sink) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IExternal>::Invoke(message);
        ...
        uint32_t Module(const uint8_t _module) override
        {
        ...
        void Evaluate() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IExternal>::Invoke(message);
        }
    ...
    public:
        ...
        void Update(const uint32_t _id) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IExternal::INotification>::Invoke(message);
        }
    ...
    public:
        ...
        void Register(Exchange::IExternal::ICatalog::INotification* _sink) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IExternal::ICatalog>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                Complete(reader);
            }
    ...
    public:
        ...
        void Activated(Exchange::IExternal* _source) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IExternal::ICatalog::INotification>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                Complete(reader);
            }
