...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePowerStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Exchange::IPower::PCState _parameter_c18dbda7 = reader.Number<Exchange::IPower::PCState>();
            const uint32_t _parameter_2f5cb346 = reader.Number<uint32_t>();

            uint32_t result = implementation->SetState(_parameter_c18dbda7, _parameter_2f5cb346);
    ...
    public:
        ...
        void Register(Exchange::IPower::INotification* _sink) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPower>::Invoke(message);
        ...
        uint32_t SetState(const Exchange::IPower::PCState _parameter_c18dbda7, const uint32_t _parameter_2f5cb346) override
        {
            IPCMessage message(BaseClass::Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IPower::PCState>(_parameter_c18dbda7);
            writer.Number<uint32_t>(_parameter_2f5cb346);
        ...
        void PowerKey() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IPower>::Invoke(message);
        }
    ...
    public:
        ...
        void StateChange(const Exchange::IPower::PCState _origin, const Exchange::IPower::PCState _destination, const Exchange::IPower::PCPhase _phase) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IPower::INotification>::Invoke(message);
        }
