...
namespace ProxyStubs {
    ...
    public:
        ...
        void Register(Exchange::IVolumeControl::INotification* _sink) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IVolumeControl>::Invoke(message);
        ...
        uint32_t Muted(const bool _muted) override
        {
            ...
            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IVolumeControl>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        void Volume(const uint8_t _volume) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IVolumeControl::INotification>::Invoke(message);
        }
