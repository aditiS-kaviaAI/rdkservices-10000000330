...
//   - /* instantiated */ template class RPC::IIteratorType<typename ELEMENT, const uint32_t> [with ELEMENT = AudioCodec, INTERFACE_ID = ID_PLAYER_PROPERTIES_AUDIO]
//   - /* instantiated */ template class RPC::IIteratorType<typename ELEMENT, const uint32_t> [with ELEMENT = VideoCodec, INTERFACE_ID = ID_PLAYER_PROPERTIES_VIDEO]
...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceC5942090 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceC5942090StubMethods[] = {
        // (0) virtual bool Next(Exchange::IPlayerProperties::AudioCodec&) = 0
        //
    ...
    }; // RPCIteratorTypeInstanceC5942090StubMethods

    //
    // RPC::IIteratorTypeInstance568419F3 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance568419F3StubMethods[] = {
        // (0) virtual bool Next(Exchange::IPlayerProperties::VideoCodec&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
    ...
    }; // RPCIteratorTypeInstance568419F3StubMethods
    ...
    //
    // RPC::IIteratorTypeInstanceC5942090 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPlayerProperties::AudioCodec&) = 0
    //  (1) virtual bool Previous(Exchange::IPlayerProperties::AudioCodec&) = 0
    ...
    class RPCIteratorTypeInstanceC5942090Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>> {
    public:
        RPCIteratorTypeInstanceC5942090Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
        ...
        bool Next(Exchange::IPlayerProperties::AudioCodec& _info) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>>::Invoke(message);
        ...
        void Reset(const uint32_t _position) override
        {
            ...
            ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>>::Invoke(message);
        }
    ...
    }; // class RPCIteratorTypeInstanceC5942090Proxy

    //
    // RPC::IIteratorTypeInstance568419F3 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPlayerProperties::VideoCodec&) = 0
    //  (1) virtual bool Previous(Exchange::IPlayerProperties::VideoCodec&) = 0
    ...
    class RPCIteratorTypeInstance568419F3Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>> {
    public:
        RPCIteratorTypeInstance568419F3Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
        ...
        bool Next(Exchange::IPlayerProperties::VideoCodec& _info) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Boolean();
        ...
        void Reset(const uint32_t _position) override
        {
            ...
            ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>>::Invoke(message);
        }
    ...
    }; // class RPCIteratorTypeInstance568419F3Proxy
    ...
    public:
        ...
        uint32_t AudioCodecs(Exchange::IPlayerProperties::IAudioCodecIterator*& _codec) const override
        {
            ...
            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPlayerProperties>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>, RPCIteratorTypeInstanceC5942090StubMethods> RPCIteratorTypeInstanceC5942090Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>, RPCIteratorTypeInstance568419F3StubMethods> RPCIteratorTypeInstance568419F3Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>, RPCIteratorTypeInstanceC5942090Proxy, RPCIteratorTypeInstanceC5942090Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>, RPCIteratorTypeInstance568419F3Proxy, RPCIteratorTypeInstance568419F3Stub>();
