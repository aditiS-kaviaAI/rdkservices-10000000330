...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeApplicationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Exchange::IApplication::launchpointtype _parameter_2987b0a7 = reader.Number<Exchange::IApplication::launchpointtype>();

            uint32_t result = implementation->LaunchPoint(static_cast<const Exchange::IApplication::launchpointtype&>(_parameter_2987b0a7));
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const bool _parameter_6e62a6dc = reader.Boolean();

            uint32_t result = implementation->Visible(static_cast<const bool&>(_parameter_6e62a6dc));
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_ca235328 = reader.Text();

            uint32_t result = implementation->Language(static_cast<const string&>(_parameter_ca235328));
    ...
    public:
        ...
        void Register(Exchange::IApplication::INotification* _sink) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IApplication>::Invoke(message);
        ...
        uint32_t Reset(const Exchange::IApplication::resettype _type) override
        {
            ...
            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IApplication>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
        ...
        uint32_t LaunchPoint(const Exchange::IApplication::launchpointtype& _parameter_2987b0a7) override
        {
            IPCMessage message(BaseClass::Message(6));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IApplication::launchpointtype>(static_cast<const Exchange::IApplication::launchpointtype&>(_parameter_2987b0a7));
        ...
        uint32_t Visible(const bool& _parameter_6e62a6dc) override
        {
            IPCMessage message(BaseClass::Message(8));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Boolean(static_cast<const bool&>(_parameter_6e62a6dc));
        ...
        uint32_t Language(const string& _parameter_ca235328) override
        {
            IPCMessage message(BaseClass::Message(10));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(static_cast<const string&>(_parameter_ca235328));
    ...
    public:
        ...
        void VisibilityChange(const bool _hidden) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IApplication::INotification>::Invoke(message);
        }
