...
namespace ProxyStubs {
    ...
    public:
        ...
        void Setup() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::ITestController>::Invoke(message);
        }
        ...
        Exchange::ITestController::ICategory::IIterator* Categories() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ITestController>::Invoke(message);
    ...
    public:
        ...
        string Execute(const string& _params) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ITestController::ITest>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Text();
            }
    ...
    public:
        ...
        void Reset() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::ITestController::ITest::IIterator>::Invoke(message);
        }
        ...
        bool IsValid() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ITestController::ITest::IIterator>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        string Name() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ITestController::ICategory>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Text();
            }
        ...
        void Setup() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::ITestController::ICategory>::Invoke(message);
        }
    ...
    public:
        ...
        void Reset() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::ITestController::ICategory::IIterator>::Invoke(message);
        }
        ...
        bool IsValid() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ITestController::ICategory::IIterator>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Boolean();
            }
