...
namespace ProxyStubs {
    ...
    public:
        ...
        uint32_t Register(Exchange::IStore::INotification* _notification) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IStore>::Invoke(message);
    ...
    public:
        ...
        void ValueChanged(const string& _ns, const string& _key, const string& _value) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IStore::INotification>::Invoke(message);
        }
