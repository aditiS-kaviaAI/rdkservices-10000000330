...
namespace ProxyStubs {
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _service) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IContentDecryption>::Invoke(message);
    ...
    public:
        ...
        void initializationStatus(const std::string& _drm, const Exchange::IContentDecryption::Status _status) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IContentDecryption::INotification>::Invoke(message);
        }
