...
namespace ProxyStubs {
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _service) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IDsgccClient>::Invoke(message);
        ...
        void Restart() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IDsgccClient>::Invoke(message);
        }
    ...
    public:
        ...
        void StateChange(const Exchange::IDsgccClient::state _newState) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IDsgccClient::INotification>::Invoke(message);
        }
