...
namespace ProxyStubs {
    ...
    public:
        ...
        string Metadata() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IStream>::Invoke(message);
        ...
        void Callback(Exchange::IStream::ICallback* _callback) override
        {
    ...
    public:
        ...
        Exchange::IStream::IElement::type Type() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IStream::IElement>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        void Reset() override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IStream::IElement::IIterator>::Invoke(message);
        }
        ...
        bool IsValid() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IStream::IElement::IIterator>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        RPC::IValueIterator* Speeds() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IStream::IControl>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
        ...
        void Speed(const int32_t _request) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IStream::IControl>::Invoke(message);
        }
    ...
    public:
        ...
        uint32_t X() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IStream::IControl::IGeometry>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
            }
    ...
    public:
        ...
        void Event(const uint32_t _eventid) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IStream::IControl::ICallback>::Invoke(message);
        }
    ...
    public:
        ...
        void DRM(const uint32_t _state) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IStream::ICallback>::Invoke(message);
        }
    ...
    public:
        ...
        Exchange::IStream* CreateStream(const Exchange::IStream::streamtype _streamType) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPlayer>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
