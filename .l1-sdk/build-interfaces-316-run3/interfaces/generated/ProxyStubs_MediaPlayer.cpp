...
namespace ProxyStubs {
    ...
    public:
        ...
        Exchange::IMediaPlayer::IMediaStream* CreateStream(const string& _id) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IMediaPlayer>::Invoke(message);
    ...
    public:
        ...
        uint32_t Load(const string& _url, bool _autoPlay) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IMediaPlayer::IMediaStream>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        void Event(const string& _eventName, const string& _parametersJson) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IMediaPlayer::IMediaStream::INotification>::Invoke(message);
        }
