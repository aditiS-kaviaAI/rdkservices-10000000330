...
namespace ProxyStubs {
    ...
    public:
        ...
        void Register(Exchange::IPackager::INotification* _observer) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPackager>::Invoke(message);
    ...
    public:
        ...
        Exchange::IPackager::state State() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPackager::IInstallationInfo>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        string Name() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPackager::IPackageInfo>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Text();
            }
    ...
    public:
        ...
        void StateChange(Exchange::IPackager::IPackageInfo* _package, Exchange::IPackager::IInstallationInfo* _install) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPackager::INotification>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                Complete(reader);
            }
        ...
        void RepositorySynchronize(uint32_t _status) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IPackager::INotification>::Invoke(message);
        }
