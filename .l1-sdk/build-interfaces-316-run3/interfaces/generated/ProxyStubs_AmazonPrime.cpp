...
namespace ProxyStubs {
    ...
    public:
        ...
        void Register(Exchange::IAmazonPrime::INotification* _ignition) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IAmazonPrime>::Invoke(message);
        ...
        uint32_t Send(const string& _message) override
        {
            ...
            Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IAmazonPrime>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
    ...
    public:
        ...
        void Receive(const string& _message) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IAmazonPrime::INotification>::Invoke(message);
        }
