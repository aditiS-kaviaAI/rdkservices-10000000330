...
namespace ProxyStubs {
    ...
    public:
        ...
        uint32_t KeyEvent(const bool _pressed, const uint32_t _code, const string& _table) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IKeyHandler>::Invoke(message);
        ...
        void ProducerEvent(const string& _producerName, const Exchange::ProducerEvents _event) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IKeyHandler>::Invoke(message);
        }
    ...
    public:
        ...
        uint32_t AxisEvent(const int16_t _x, const int16_t _y) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IWheelHandler>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
            }
    ...
    public:
        ...
        uint32_t PointerMotionEvent(const int16_t _x, const int16_t _y) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPointerHandler>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
            }
    ...
    public:
        ...
        uint32_t TouchEvent(const uint8_t _index, const Exchange::ITouchHandler::touchstate _state, const uint16_t _x, const uint16_t _y) override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ITouchHandler>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Number<uint32_t>();
            }
    ...
    public:
        ...
        string Name() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IKeyProducer>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Text();
            }
        ...
        void Configure(const string& _settings) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IKeyProducer>::Invoke(message);
        }
    ...
    public:
        ...
        string Name() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IWheelProducer>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Text();
            }
        ...
        void Configure(const string& _settings) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IWheelProducer>::Invoke(message);
        }
    ...
    public:
        ...
        string Name() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::IPointerProducer>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Text();
            }
        ...
        void Configure(const string& _settings) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::IPointerProducer>::Invoke(message);
        }
    ...
    public:
        ...
        string Name() const override
        {
            ...
            const Core::hresult hresult = ProxyStub::UnknownProxyType<Exchange::ITouchProducer>::Invoke(message);
            if (hresult == Core::ERROR_NONE) {
                RPC::Data::Frame::Reader reader(message->Response().Reader());
                result = reader.Text();
            }
        ...
        void Configure(const string& _settings) override
        {
            ...
            ProxyStub::UnknownProxyType<Exchange::ITouchProducer>::Invoke(message);
        }
