...
ENUM_CONVERSION_BEGIN(JsonData::PlayerInfo::DolbyType)
    { JsonData::PlayerInfo::DolbyType::DIGITAL_PCM, _TXT("DIGITAL_PCM") },
    { JsonData::PlayerInfo::DolbyType::DIGITAL_PLUS, _TXT("DIGITAL_PLUS") },
    { JsonData::PlayerInfo::DolbyType::DIGITAL_AC3, _TXT("DIGITAL_AC3") },
    { JsonData::PlayerInfo::DolbyType::AUTO, _TXT("AUTO") },
ENUM_CONVERSION_END(JsonData::PlayerInfo::DolbyType);
