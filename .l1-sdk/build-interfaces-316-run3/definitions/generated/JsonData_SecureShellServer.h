...
namespace JsonData {
    ...
    namespace SecureShellServer {
        ...
        class Get_active_sessions_infoResultData : public Core::JSON::Container {
        public:
            Get_active_sessions_infoResultData()
                : Core::JSON::Container()
            {
                _Init();
            }

            Get_active_sessions_infoResultData(const Get_active_sessions_infoResultData& _other)
                : Core::JSON::Container()
                , Pid(_other.Pid)
            ...
            Get_active_sessions_infoResultData& operator=(const Get_active_sessions_infoResultData& _rhs)
            {
                Pid = _rhs.Pid;
        ...
        }; // class Get_active_sessions_infoResultData
