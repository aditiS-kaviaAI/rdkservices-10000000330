            ...
            _module_.Register<Core::JSON::ArrayType<Core::JSON::String>, Core::JSON::ArrayType<Core::JSON::String>>(_T("userscripts"), 
                [_impl_](const Core::JSON::ArrayType<Core::JSON::String>& params, Core::JSON::ArrayType<Core::JSON::String>& result) -> uint32_t {
                    ...
                    if (params.IsSet() == false) {
                        // property get
                        RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>* _result{};
                        ...
                        if (_errorCode == Core::ERROR_NONE) {
                            ...
                            if (_result != nullptr) {
                                string _paramsItem_{};
                                while (_result->Next(_paramsItem_) == true) { result.Add() = _paramsItem_; }
                                _result->Release();
                            }
                        }
                        ...
                        RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>* const _params{Core::Service<RPC::IteratorType<RPC::IIteratorType<string,
                                 RPC::ID_STRINGITERATOR>>>::Create<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>>(_elements)};
